(function () {
    ...
    function piePagina() {
        return {
            restrict: 'E',
            replace: 'true',
            template: '<footer class="container"><hr/><p class="text-center">Desarrollado con AngularJS. Por Alberto Basalo - <a href="http://agorabinaria.com">Ágora Binaria SL</a></p></footer>'
        };
    };
